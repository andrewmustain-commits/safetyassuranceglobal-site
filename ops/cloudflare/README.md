...
- `.github/workflows/cloudflare-inquiry-activate.yml` runs only when a push to `main` changes the request marker **and** the entire triggering commit message is exactly `ACTIVATE_INQUIRY_DELIVERY`.
