...
At the time of v29 release, GitHub reported `main` as unprotected. Branch-protection configuration is the immediate repository-governance follow-up and is intentionally separate from the public runtime release.
